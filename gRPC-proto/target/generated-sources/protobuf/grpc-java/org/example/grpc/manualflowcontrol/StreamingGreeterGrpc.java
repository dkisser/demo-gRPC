package org.example.grpc.manualflowcontrol;
...
public final class StreamingGreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.example.grpc.manualflowcontrol.HelloRequest,
      org.example.grpc.manualflowcontrol.HelloReply> getSayHelloStreamingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHelloStreaming",
      requestType = org.example.grpc.manualflowcontrol.HelloRequest.class,
      responseType = org.example.grpc.manualflowcontrol.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<org.example.grpc.manualflowcontrol.HelloRequest,
      org.example.grpc.manualflowcontrol.HelloReply> getSayHelloStreamingMethod() {
    io.grpc.MethodDescriptor<org.example.grpc.manualflowcontrol.HelloRequest, org.example.grpc.manualflowcontrol.HelloReply> getSayHelloStreamingMethod;
      ...
      synchronized (StreamingGreeterGrpc.class) {
        if ((getSayHelloStreamingMethod = StreamingGreeterGrpc.getSayHelloStreamingMethod) == null) {
          StreamingGreeterGrpc.getSayHelloStreamingMethod = getSayHelloStreamingMethod =
              io.grpc.MethodDescriptor.<org.example.grpc.manualflowcontrol.HelloRequest, org.example.grpc.manualflowcontrol.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHelloStreaming"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.grpc.manualflowcontrol.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.grpc.manualflowcontrol.HelloReply.getDefaultInstance()))
  ...
  public static abstract class StreamingGreeterImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<org.example.grpc.manualflowcontrol.HelloRequest> sayHelloStreaming(
        io.grpc.stub.StreamObserver<org.example.grpc.manualflowcontrol.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                org.example.grpc.manualflowcontrol.HelloRequest,
                org.example.grpc.manualflowcontrol.HelloReply>(
  ...
  private static abstract class StreamingGreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.example.grpc.manualflowcontrol.HelloStreamingProto.getDescriptor();
    }
